        ...
        <>
           <section className="flex justify-center items-center w-full bg-[#121212] z-10" id="about">
             <div className="flex flex-col gap-6 mt-24 pb-6">
                ...
                <div className="w-[400px] sm:w-[480px] md:w-[640px] lg:w-[800px] px-4">
                <p className="text-white text-center text-[14px] sm:text-sm md:text-sm lg:text-base  md:whitespace-normal mx-3">
